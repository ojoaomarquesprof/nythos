...
export function DashboardHero() {
  ...
  return (
    <section className="animate-fade-in overflow-hidden rounded-3xl border border-primary/10 bg-card/90 shadow-[0_18px_50px_rgba(41,31,67,0.08)] ring-1 ring-white/80">
      <div className="relative grid gap-5 p-5 md:grid-cols-[minmax(0,1fr)_auto] md:items-center md:p-6">
        ...
        <div className="relative flex flex-wrap gap-2 md:justify-end">
          <Link
            ...
            className={cn(buttonVariants({ size: "lg" }), "h-10 rounded-2xl shadow-primary/20")}
          >
          ...
          <Link
            href="/dashboard/schedule"
            className={cn(buttonVariants({ variant: "outline", size: "lg" }), "h-10 rounded-2xl bg-white/80")}
          >
