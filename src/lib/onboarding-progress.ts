...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    description: "Nome, CRP e clinica deixam seus documentos e recibos consistentes.",
    ctaLabel: "Completar perfil",
    href: "/dashboard/settings",
  },
  {
    id: "default_session_price",
    title: "Defina o valor padrao da sessao",
    description: "A agenda ja nasce com uma referencia financeira organizada.",
  ...
  },
  {
    ...
    description: "Crie a base para prontuario, agenda, portal e financeiro.",
  ...
  },
  {
    ...
    description: "Transforme o cadastro em rotina clinica acompanhavel.",
  ...
  },
  {
    ...
    description: "Importe bloqueios externos e reduza conflitos de horario.",
    ctaLabel: "Conectar agenda",
    href: "/dashboard/schedule",
  },
  {
    id: "clinic_identity",
    title: "Configure identidade da clinica",
    description: "Logo ou assinatura dao acabamento profissional aos PDFs.",
    ctaLabel: "Configurar marca",
    href: "/dashboard/settings",
  },
  {
    id: "patient_portal",
    title: "Conheca o portal do paciente",
    description: "Libere tarefas, check-ins e acompanhamento entre sessoes.",
    ctaLabel: "Ver portal",
  ...
  },
  {
    ...
    description: "Opcional, mas util para planos de acompanhamento recorrente.",
